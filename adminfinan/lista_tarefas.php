...
?>
					<div class="art-layout-cell art-content">
						<article class="art-post art-article">
							<h2 class="art-postheader">Listagem para: Tarefas</h2>
							<div class="art-postheadericons art-metadata-icons">
								 <span class="art-postediticon"> <a href="formulario_tarefas.php" title="Novo Registro">Inserir novo registro</a></span>
							</div>
...
?>
													<tr>
														<td style="cursor: pointer;" onclick="javascript:window.location.assign('formulario_tarefas.php?id=<?=$res[$cfg_campo_chave]?>');"><?=$res[$cfg_campo_chave]?></td>
														<td style="cursor: pointer;" onclick="javascript:window.location.assign('formulario_tarefas.php?id=<?=$res[$cfg_campo_chave]?>');"><?=$res[$cfg_campo_descricao]?></td>
